...
export default function CongestionGraph() {
  ...
  const checkData = [
    {
      q: "Slow Start?¼ëŠ” ?´ë¦„?¸ë° ??cwndê°€ ì§€?˜ì ?¼ë¡œ(2ë°°ì”©) ì¦ê??˜ëŠ”ê°€?\n?´ë¦„????Slow Start?¸ê??",
      a: "?´ë¦„?€ '?ë¦¬ê²??œì‘?œë‹¤'???˜ë?????cwndë¥?1?ì„œ ?œì‘?˜ê¸° ?Œë¬¸?´ë‹¤.\nì¦ê? ë°©ì‹?€ ì§€?˜ì ?´ì?ë§? 0?ì„œ ?œì‘?˜ëŠ” ê²ƒë³´?¤ëŠ” ?ˆì „?˜ê²Œ ?ìƒ‰?œë‹¤???˜ë??ì„œ Slow??\nACK ?˜ë‚˜??cwndë¥?1???˜ë¦¬ë©? ??Round??cwndê°œì˜ ACKê°€ ?¤ë?ë¡?nê²°ê³¼?ìœ¼ë¡???Roundë§ˆë‹¤ cwndê°€ 2ë°°ê? ?œë‹¤."
    },
    {
      q: "3-Dup-ACK?€ Timeout?€ ?????¨í‚· ?ì‹¤???˜ë??˜ëŠ”??n??TCP???˜ì„ ?¤ë¥´ê²?ì²˜ë¦¬?˜ëŠ”ê°€?",
      a: "3-Dup-ACK: ?ì‹¤???¨í‚· ?´í›„ ?¨í‚·?¤ì´ ê³„ì† ?„ì°©?˜ê³  ?ˆë‹¤???»ì´??\n?¤íŠ¸?Œí¬???„ì§ ?™ì‘ ì¤????¼ì¡???¬í•˜ì§€ ?ŠìŒ ??cwndë¥??ˆë°˜ë§?ì¤„ì´ê³?CA ? ì?.\nTimeout: ?„ë¬´ ?¨í‚·???„ì°©?˜ì? ?ŠëŠ”?? ?¤íŠ¸?Œí¬ê°€ ?„ì „??ë§‰í˜”??ê°€?¥ì„±???’ë‹¤.\n??ë³´ìˆ˜?ìœ¼ë¡??€????cwndë¥?1ë¡?ì´ˆê¸°?”í•˜ê³?Slow Start ?¬ì‹œ??"
    },
    {
      q: "?¼ì¡ ?œì–´ê°€ ?†ë‹¤ë©??¸í„°?·ì—???´ë–¤ ?¼ì´ ?¼ì–´?˜ëŠ”ê°€?",
      a: "ëª¨ë“  TCP ?°ê²°??ìµœë? ?ë„ë¡?ê³„ì† ?„ì†¡?œë‹¤.\n?¼ìš°???ê? ê°€??ì°¨ì„œ ?¨í‚·???€ê·œëª¨ë¡??ì‹¤?œë‹¤.\n?ì‹¤??ê°ì???sender?¤ì´ ?¬ì „?¡í•˜ë©??¸ë˜?½ì´ ??ì¦ê??œë‹¤.\nê²°êµ­ ?¤íŠ¸?Œí¬ ?„ì²´ê°€ ë¶•ê´´?œë‹¤ ???´ë? Congestion Collapse???œë‹¤.\n1986???¤ì œë¡??¸í„°?·ì´ ???íƒœê°€ ?ê³ , ?´í›„ TCP ?¼ì¡ ?œì–´ê°€ ?„ì…?ë‹¤."
    }
  ];
    ...
    <div className="w-full flex-1 flex flex-col gap-4">
      ...
      <div className="flex-1 bg-white/5 border border-white/10 rounded-xl p-5 flex flex-col">
        ...
        <div className="flex flex-wrap gap-4 mt-3 text-xs font-medium border-t border-white/5 pt-3">
          {[
            ['#10b981', 'Slow Start (exponential Ã—2)'],
